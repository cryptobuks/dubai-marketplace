...
<div class=" content-area">
    <div class="page-header">
        <h4 class="page-title"><i class="fa fa-random"></i> {{isset($title) ? $title : ''}}</h4>
        <ol class="breadcrumb">
                ...
                <div class="row">
                    ...
                    <div class="col-8">
                        <div class="card-body p-4">
                                ...
                                <h2 class="mb-3">{{ getPhrase('add')}}</h2>
                            <h5 class="font-weight-normal mb-0">{{ getPhrase('create')}}</h5> 
                        </div>
                    </div>
                </div>
            </div>
