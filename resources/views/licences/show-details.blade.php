    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{URL_DASHBOARD}}"><i class="fa fa-home"></i>  {{ getPhrase('home') }}</a></li>
             <li class="breadcrumb-item active" aria-current="page">{{ getPhrase('licences_dashboard')}}</li>
             <li class="breadcrumb-item active" aria-current="page">{{ getPhrase('licences_list')}}</li>
