...
@section('content')
    ...
    <section class=" login-banner " style="padding-top:120px;padding-bottom:0px">
        <div class="container">
            <div class="row">
                <div class="  col-sm-12">
                     <h2 style="color:black">Everything you need to buy and sell websites, <br> businesses, domains and apps.</h2>
                </div>
            </div>
        </div>
    </section>
