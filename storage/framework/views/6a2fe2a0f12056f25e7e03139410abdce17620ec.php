...
<div class=" content-area">
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(URL_ADMIN_USERS_DASHBOARD); ?>"><?php echo e(getPhrase('users_dashboard')); ?></a> </li>
        ...
        <div class="content-wrapper">
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6">
                    ...
                    <a href="<?php echo e(URL_IMPORT . 'user'); ?>" class="btn btn-primary  "><?php echo e(getPhrase('Import')); ?></a> 
                    <a href="<?php echo e(URL_USERS_ADD); ?>" class="btn btn-primary  "><?php echo e(getPhrase('Add')); ?></a>
