    ...
    <div class="page-header">
        ...
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo e(PREFIX); ?>"><i class="fa fa-home"></i>  <?php echo e(getPhrase('home')); ?></a></li>
             <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(URL_LICENCES_DASHBOARD); ?>"><?php echo e(getPhrase('licences_dashboard')); ?></a></li>
             <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(URL_LICENCES); ?>"> <?php echo e(getPhrase('licences_list')); ?></a></li>
